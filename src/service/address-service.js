...
const update = async (user, contactId, request) => {
    ...
    //pastikan user sesuai dengan contact id untuk mengakses address
    const totalAddresInDatabase = await prismaClient.address.count({
        where: {
            contact_id: contactId,
            id: address.id
        }
