...
const get = async (user, contactId) => {
    ...
    //find contact di database berdasarkan username
    const contact = await prismaClient.contact.findFirst({
        where: {
            //jangan sampai mengambil data contact dari user lain!
...
const update = async (user, request) => {
    ...
    //find contact didatabase berdasarkan username
